(() => {
  ...
  N.config = {
    version: '4.1.0',
    storageKey: 'noviq-v4.1-state',
    legacyKeys: ['noviq-v4-state', 'noviq-v3.3-state', 'noviq-v3.2-state', 'noviq-v2-state', 'noviq-v1.4-state', 'noviq-v1.2-state', 'noviq-v1.1-state', 'noviq-v1-state'],
    demoMode: true,
  ...
  N.defaultState = {
    ...
    account: { mode:'local', email:null, synced:false },
