...
assert.deepEqual(scripts, ['polyfills-v52.js','data.js','core-v52.js','platform-v6.js','app-v52.js','a11y-v52.js','mvp-beta.js']);
assert.deepEqual(stylesheets, ['styles-v52.css','mvp-beta.css']);
assert.ok(index.includes('NOVIQ 6 MVP'));
assert.ok(manifest.name.includes('6 MVP'));
...
assert.ok(sw.includes("const VERSION='6.0.1-mvp'"));
...
console.log('NOVIQ 6 MVP structural checks passed.');
