...
assert.deepEqual(scripts, ['polyfills-v52.js','data.js','core-v52.js','app-v52.js','a11y-v52.js']);
...
assert.ok(core.includes("saved.language === 'ua' ? 'uk'"), 'UA to UK migration missing');
