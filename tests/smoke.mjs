...
assert.ok(index.includes('NOVIQ 2.0'), 'index must identify NOVIQ 2.0');
...
assert.ok(config.includes("version: '2.0.0'"), 'config version must be 2.0.0');
...
assert.ok(styles.includes('styles-editorial.css'), 'editorial design layer must be loaded');
